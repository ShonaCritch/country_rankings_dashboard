...
//Function to highlight map
function highlightmap(count) {

  if (count == "USA") {
    d3.select("#UnitedStatesofAmerica").attr("fill", "#FF0000")
  }
  else if (count == "UK") {
    d3.select("#UnitedKingdom").attr("fill", "#FF0000")
  }
  else if (count == "Hong Kong") {
    d3.select("#HongKong").attr("fill", "#FF0000")
  }
  else {
...
function fillall(count) {
  d3.selectAll("path").attr("fill", "#000000")
  console.log(count)}
